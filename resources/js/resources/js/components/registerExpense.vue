<template>
  <div>
    ...
    <div>
        ...
        <div class="form-group">
            <label for="inputType">Type Movement<i style="color: red;">*</i></label>
          ...
          <div v-if="typeMovement === 'e'">
            ...
            <div v-if="typePayment === 'mb'">
                <div class="form-group">
                    <label for="inputCode">Code<i style="color: red;">*</i></label>
                    <input id="inputCode" class="form-control" v-model="mbCode"/>
                </div>
                <div class="form-group">
                    <label for="inputRef">Reference<i style="color: red;">*</i></label>
            ...
            <div v-if="typePayment === 'bt'">
                <div class="form-group">
                    <label for="inputIBAN">IBAN<i style="color: red;">*</i></label>
