    ...
    <div>
      <div v-show="!walletExist">
        <div class="form-group">
          <label for="inputEmail">Wallet Email<i style="color: red;">*</i></label>
      ...
      <div v-show="walletExist">
        <div v-for="wallet in wallets" :key="wallet.id">
          <div class="form-group">
            <label for="inputValue">Value<i style="color: red;">*</i></label>
            <input type="text" name="nif" id="inputValue" class="form-control" v-model="value" />
          </div>
          <div class="form-group">
            <label for="inputType">Type Payment<i style="color: red;">*</i></label>
          ...
          <div class="form-group">
            <a class="btn btn-primary" v-on:click.prevent="registerIncomeMovement(wallet.id, email,value, typePayment, IBAN, description, wallet.balance)">Register</a>
          </div>
        </div>
      </div>
    </div>
...
export default {
  ...
  methods: {
    ...
    registerIncomeMovement(id, email, value, typePayment, IBAN, description, balance) {
